      ...
      <Containericones >
        <Iconesinfo >
          <a style={{marginBottom:"20px"}} href="mailto:contatomatheusbarreto@hotmail.com" target="blank">
            <DivBox><img  style={{padding: "1vw"}}src="./assets/imgsiconscontatos/mail.svg" alt="" /></DivBox>
          </a>
        ...
        <Iconesinfo>
          <a target="blank" style={{marginBottom:"20px"}} href="https://api.whatsapp.com/send?phone=5571994157466">
            <DivBox>< img  style={{padding: "1vw"}} src="./assets/imgsiconscontatos/phone.svg" alt="" /></DivBox>
          </a>
        ...
        <Iconesinfo>
          <a target="blank" style={{marginBottom:"20px"}}href="https://www.linkedin.com/in/matheus-almada-a064b2189/">
            <DivBox><img style={{padding: "1vw"}} src="./assets/imgsiconscontatos/linkedin.svg" alt="" /></DivBox>
          </a>
        ...
        <Iconesinfo>
          <a target="blank" style={{marginBottom:"20px"}}href="https://github.com/MatheusAllmada">
            <DivBox><img style={{padding: "1vw"}}src="./assets/imgsiconscontatos/github.svg" alt="" /></DivBox>
          </a>
